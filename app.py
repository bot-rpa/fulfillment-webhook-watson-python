...
def makeWebhookResult(duration,servicetype):
    ...
    output_speech = "Your " + servicetype + "                123                   usage for the duration " + duration + " is " + usage + " units which costs " + str(float(usage) * 0.45) + " pounds. Any thing else I can do for you."
    return {
